...
-   You must be authentic to join. Spam accounts are never accepted. This means that you must:
    -   Rename your account using first & last names and put personal picture (preferably) so that the server feels authentic/sociable.
    -   Send your Facebook or LinkedIn and we will message you to check. (Note: account must have your personal picture and must be authentic حقيقي, Don't send locked FB accounts)
    -   If you can't do step "b.", picture your ID (without SSN) beside the server.
    -   بالعربي: صور بطاقتك (من غير الرقم القومي) جنب شاشة الجهاز وانت فاتح عليه السيرفر وابعتها خاص.
