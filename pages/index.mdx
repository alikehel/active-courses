...
<>
	...
	<p className="text-center text-lg mb-2 text-gray-600 md:!text-2xl">Welcome to Active Course - Your Hub for CS Study!</p>
</>
}
...
<Callout type="info" emoji="💬">
	Join Active Course now and take your CS studies to new heights: [Active Courses Discord](https://discord.gg/QrfTN2Aukx)
</Callout>
